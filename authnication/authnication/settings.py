...
SECRET_KEY = 'django-insecure-!bw@(^py0+&ihbozg0p$c2utm_eora@=&j_$wrepz@65&n%-h7'
...
ROOT_URLCONF = 'authnication.urls'
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticated',  # Permission classes
    ],
